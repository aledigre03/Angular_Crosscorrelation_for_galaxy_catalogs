...
plt.plot(redshift_bins, rhoint, 'o', label='interlopers fraction', color='blue')
plt.plot(redshift_bins, rhoref, 'o', label='reference catalog', color='green')
plt.plot(euclid_bins, rhotarg_whole, 'o', label='Euclid mock catalog sample', color='purple')

# Adding titles and labels
plt.title('Number densities')
plt.xlabel('Redshift Bins')
plt.ylabel(r'$N \, / \, (\mathrm{Mpc}^3/h^3)$')
plt.yscale('log')
plt.legend()
